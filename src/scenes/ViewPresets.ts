...
export const SURGICAL_VIEWS: ViewPreset[] = [
  ...
  },
  {
    ...
    label: '鼓膜ビュー（外耳道軸）',
    short: '鼓膜',
    // 外耳道口（+X側）から-X方向を向いて鼓膜を直視（耳鏡視野距離 ~17mm）
    // 鼓膜中心: world[5.5, 0, 0] ← UMBO_POS world[5,0,0] + 0.5mm余裕
    view: { pos: [22, 3, 0], target: [5.5, 0, 0], up: [0, 1, 0] },
  },
  {
    key: 'microscope',
    label: '手術顕微鏡（鼓室形成術）',
    short: '顕微鏡視野',
    // 術者視点: 外側やや上方から外耳道を通じて鼓室を観察（顕微鏡作業距離 ~24mm）
    // short は表示モード切替の「🔬顕微鏡」ボタンと語を分離するため「顕微鏡視野」とする(H3-a)
    view: { pos: [28, 10, 0], target: [5, 2, 0], up: [0, 1, 0] },
  },
  {
    key: 'tympanoplasty',
    label: '鼓室正面（プロステーシス設置）',
    short: '鼓室正面',
    // 外耳道から鼓室直視: 近距離（プロステーシス設置視野 ~17mm）
    view: { pos: [18, 5, 2], target: [3, 1, 0], up: [0, 1, 0] },
  },
  {
    key: 'ossicles',
    label: '耳小骨ビュー（鼓室内）',
    short: '耳小骨',
    // 前上外側から耳小骨連鎖（ツチ骨〜アブミ骨）を観察（~15mm）
    // target: アブミ骨底板[0,0,0]〜臍部[5,0,0]の中心付近
    view: { pos: [15, 8, 5], target: [3, 2, 0.5], up: [0, 1, 0] },
  },
  {
    key: 'mastoidectomy',
    label: '乳突削開アプローチ',
